...
#define HEX4(x) "0x" << std::setfill('0') << std::setw(4) << std::hex << std::uppercase << unsigned(x) << std::dec << std::nouppercase
#define HEX2(x) "0x" << std::setfill('0') << std::setw(2) << std::hex << std::uppercase << unsigned(x) << std::dec << std::nouppercase
